		...
		while(keepGoing){
			...
			try{
				...
				case 4:
					try{
						Solve sol = new Solve();
						ArrayList<Board> solvedb = sol.solveWithStats(board);
						System.out.println("The returned boards looks like: ");
						
						for(Board b: solvedb){
							b.printBoard();
						}
						System.out.println("Total valid states to find solutions: " + sol.getStattotal());
						System.out.println("Total unique solutions: " + sol.getStatunique());
						System.out.println("Total solutions: " + sol.getTotal());
